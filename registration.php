...
if(isset($_POST['s'])){
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        // Sanitize and prepare input to prevent SQL injection
        ...
        $u_addr = mysqli_real_escape_string($con, $u_addr);
        $a_no = mysqli_real_escape_string($con, $a_no);
        ...
        if(mysqli_num_rows($check_result) > 0) {
            ...
            // Insert new user
            $reg="INSERT INTO user VALUES('$u_name','$u_id','$hashed_password','$u_addr','$a_no','$gen','$mob')";
            
            // Use mysqli_select_db with the connection object and database name
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">Home Address</p><input type="text"  name="address"  required="" id="addr" onfocusout="f1()"/>
